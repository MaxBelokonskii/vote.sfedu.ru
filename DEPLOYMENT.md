...
Sentry удалён из проекта. Ошибки приложения пишутся в стандартный Rails-лог
(stdout контейнера). Используйте команды ниже для просмотра ошибок в реальном времени.
